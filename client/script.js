...
const repeatP = document.getElementById('repeat-text'); 
repeatP.textContent = res.data; 
...
// CODE HERE
const getQuery = () => {
    axios.get('http://localhost:3000/query-test?user=Nate&food=pizza')
    .then((res) => {
        console.log(res.data)
    })
}
...
function createFood(event) {
    ...
    const foodInput = document.querySelector('#foodText'); 
    const body = {
